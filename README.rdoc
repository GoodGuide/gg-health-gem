...
application status endpoint that is checked by an HAproxy load balancer.  It
...
To mount the engine in the host app, edit the host app's routes.rb:
  ...
  mount GoodguideHealth::Engine, at: '/(name_of_mount_path)'

For example, most GoodGuide apps mount the engine at '/health':

  mount GoodguideHealth::Engine, at: '/health'
